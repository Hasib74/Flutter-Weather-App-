...
class _RainState extends State<Rain> {
  ...
  Future<Null> _loadAssets(AssetBundle bundle) async {
    ...
    await _images.load([
      'img/weathersprites.png',
    ]);

    String json = await DefaultAssetBundle.of(context).loadString('img/weatheranimation.json');
    _sprites = new SpriteSheet(_images['img/weathersprites.png'], json);
  }
